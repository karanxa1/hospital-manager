...
import { loginWithGoogle, loginWithEmail, sendPhoneOtp, verifyPhoneOtp, getAuthErrorMessage } from "@/utils/firebase"
  ...
  return (
    <div className="flex min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          className="absolute top-20 left-10 w-72 h-72 rounded-full bg-primary/[0.03]"
          animate={{ scale: [1, 1.3, 1], x: [0, 30, 0], y: [0, -20, 0] }}
          transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
        />
        <motion.div
          className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-primary/[0.02]"
          ...
          <Card className="border-0 shadow-xl">
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-center text-sm text-muted-foreground">
                ...
                <Link to="/signup" className="font-medium underline hover:text-primary transition-colors">Sign up</Link>
              </p>
            </CardContent>
          </Card>
        </motion.div>
